        ...
        $.ajax({
            ...
            success:function (msg) {
                if (msg.statusCode == 200) {
                    window.location.href = "${pageContext.request.contextPath}/task/myList";
                }
            }
        })
    }
    ...
    <td background='${pageContext.request.contextPath}/skin/images/wbg.gif' align='center'>
      <table border='0' cellpadding='0' cellspacing='0'>
        <tr>
          ...
          <td width='160'>
          <select name='search_myStatus' style='width:150px'>
        ...
        <td width='160'>
            <select name='search_myType' style='width:150px'>
                <option value=''>选择类型...</option>
        ...
        <td width='160'>
          	<input type='text' name='search_like_myKeyword' value='' style='width:120px' />
        </td>
        <td width='110'>
    		<select name='search_sort_myOrderby' style='width:120px'>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td align="center">${task.remark}</td>
	<td align="center">
	...
	<td><a href="javascript:starkMyTask(${task.id})" >开始任务</a> | <a href="javascript:endMyTask(${task.id})">任务完成</a> | <a href="${pageContext.request.contextPath}/task/detail/${task.id}">查看详情</a></td>
</tr>
</c:forEach>
<tr bgcolor="#FAFAF1">
