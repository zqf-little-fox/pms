										...
										<TABLE id=table2 cellSpacing=1 cellPadding=0 width="100%"
											...
											<TBODY>
												...
												<TR>
													...
													<TD>
														<INPUT style="width: 80px;" class=regtxt title=请填写验证码 maxLength=25 size=16 name="code">
														<span><img id="img" src="${pageContext.request.contextPath}/code/getCode?time="<%=new Date()%>></span>
													</TD>
												</TR>
											</TBODY>
										</TABLE>
