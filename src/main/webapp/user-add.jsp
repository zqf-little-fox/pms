...
<script type="text/javascript">
	$(function () {
		$.ajax({
			type:"get",
			url:"${pageContext.request.contextPath}/pos/positionList",
        ...
        $.ajax({
            ...
            success:function (msg) {
                $(msg).each(function (index,item) {
                    var checkBox = "<input name='roleids' value='"+item.roleid+"' type='checkbox'/>"+item.rolename;
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select name="pFk" id="positionlist">
			<option>---请选择---</option>
		</select>
	</td>
</tr>
...
<tr >
	...
	<td id="roleList" align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
