    ...
    <script type="text/javascript">
        function batchDelete() {
            if (confirm("你确定要删除吗？")) {
                ...
                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/mod/del",
                    data:{"_method": "delete","ids":ids},
                    success: function (msg){
                        if (msg.statusCode == 200){
                            alert("删除成功");
                            window.location.href = "${pageContext.request.contextPath}/mod/list";
                        }
                    },
                    error: function () {
                        alert("删除失败");
...
<c:forEach items="${list}" var="model" varStatus="index">
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td align="center"><a href=''><u>${model.analysis.proname}</u></a></td>
	<td>${model.level}</td>
	<%--<td>2015-02-03</td>
	<td>2015-06-03</td>--%>
	<td><a href="${pageContext.request.contextPath}/mod/edit/${model.id}">编辑</a> | <a href="${pageContext.request.contextPath}/mod/detail/${model.id}">查看详情</a></td>
</tr>
</c:forEach>
<tr bgcolor="#FAFAF1">
