...
<script type="text/javascript">
    ...
    function getProname(pid) {
		$.ajax({
			type:"get",
			url:"${pageContext.request.contextPath}/pro/info/"+pid,
			success:function (msg) {
				$("#proname").val(msg.pname);
            }
		})
    }
</script>
...
<form id="form2" name="form2" action="${pageContext.request.contextPath}/anal/saveInfo" method="post">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select id="proList" name="id" onchange="getProname(this.value)">
			<option>---请选择---</option>
		</select>
