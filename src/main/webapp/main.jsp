...
<script type="text/javascript">
	$(function () {
		$.ajax({
			type:"get",
			url:"${pageContext.request.contextPath}/notice/latestList",
	...
	function showWindow(nid) {
	    $.ajax({
			...
			success:function (msg) {
			    $("#ntitle").text(msg.ntitle).css({"font-size":"24px","font-weight":"bold","color":"red"});
...
<div id="showdiv" style="width: 60%; margin: 0 auto; height:500px; border: 1px solid #999; display: none; position: absolute; top: 20%; left: 20%; z-index: 3; background: #fff">
	<!-- 标题 -->
	<div id="ntitle" style="background: #F8F7F7; width: 100%; height: 4rem; font-size: 0.65rem; line-height: 4rem; border: 1px solid #999; text-align: center;" >
