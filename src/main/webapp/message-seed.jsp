...
<form name="form2" id="form2" enctype="multipart/form-data" action="${pageContext.request.contextPath}/email/saveInfo" method="post">
...
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">设置时间：</td>
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input name="sendtime"/>
	</td>
</tr>
